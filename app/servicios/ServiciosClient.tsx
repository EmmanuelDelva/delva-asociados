      ...
      trigger = ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (headingRef.current) {
            const fade = Math.max(0, 1 - self.progress * 1.8);
  ...
  return (
    <main className="relative overflow-x-hidden w-full max-w-full">
      ...
      >
        ...
        >
          <p className="font-mono text-[10.5px] uppercase tracking-[0.32em] text-bone/55 mb-3">
            {t.areas.pick}
          </p>
          <p
            className="font-serif italic text-[1.3rem] md:text-[1.65rem] text-bone/80 leading-snug max-w-[42ch]"
            style={{ fontWeight: 400 }}
          >
            {locale === "es"
        ...
        >
          ...
          <div className="shrink-0 w-[18vw] flex flex-col items-center justify-center text-bone/55">
            <span style={{ width: 84, height: 84 }} className="block opacity-70">
              <BrandSigil />
            </span>
            <p
              className="mt-4 font-serif italic text-[1rem] text-center max-w-[18ch] leading-snug"
              style={{ fontWeight: 400 }}
            >
              {locale === "es"
      ...
      <section
        data-surface="dark"
        className="md:hidden relative bg-forest text-bone overflow-hidden grain pb-16 px-5"
      >
        <div className="absolute inset-0 pointer-events-none">
          <div
